...
const AboutUsSection = () => {
  return (
    <section className="bg-black rounded-3xl py-24">
      <div className="w-5/6 md:w-3/4 mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16">
        ...
        <div className="flex flex-col items-start">
          ...
          <p className="text-gray-400 text-xl md:text-2xl font-semibold mb-8">
            A story where innovation meets integration
          </p>
          <p className="text-white sm:tracking-wider  leading-relaxed  text-justify">
